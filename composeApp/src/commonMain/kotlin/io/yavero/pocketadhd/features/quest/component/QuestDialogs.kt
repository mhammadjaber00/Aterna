...
import io.yavero.pocketadhd.designsystem.component.AdhdCard
import io.yavero.pocketadhd.designsystem.component.AdhdPrimaryButton
import io.yavero.pocketadhd.domain.model.Hero
import io.yavero.pocketadhd.domain.model.QuestLoot
import io.yavero.pocketadhd.domain.model.quest.EventType
import io.yavero.pocketadhd.domain.model.quest.QuestEvent
import io.yavero.pocketadhd.ui.theme.AdhdColors
import io.yavero.pocketadhd.ui.theme.AdhdSpacing
import io.yavero.pocketadhd.ui.theme.AdhdTypography
import io.yavero.pocketadhd.ui.theme.AternaColors

@Composable
fun LootDisplayDialog(
    quest: io.yavero.pocketadhd.domain.model.Quest,
    hero: Hero?,
    loot: QuestLoot? = null,
    onDismiss: () -> Unit,
    ...
    val displayLoot = loot ?: remember(quest, hero) {
        if (hero != null) {
            io.yavero.pocketadhd.domain.util.LootRoller.rollLoot(
                                ...
                                loot.items.forEach { item ->
                                    Row(
                                        ...
                                        val icon = when (item.itemType) {
                                            io.yavero.pocketadhd.domain.model.ItemType.WEAPON -> Icons.Default.Build
                                            io.yavero.pocketadhd.domain.model.ItemType.ARMOR -> Icons.Default.Shield
                                            io.yavero.pocketadhd.domain.model.ItemType.CONSUMABLE -> Icons.Default.LocalDrink
                                            else -> Icons.Default.Inventory
                                        }
                                        val tint = when (item.rarity) {
                                            io.yavero.pocketadhd.domain.model.ItemRarity.LEGENDARY -> Color(
                                                0xFFF59E0B
                                            )

                                            io.yavero.pocketadhd.domain.model.ItemRarity.EPIC -> Color(0xFF8B5CF6)
                                            io.yavero.pocketadhd.domain.model.ItemRarity.RARE -> Color(0xFF3B82F6)
