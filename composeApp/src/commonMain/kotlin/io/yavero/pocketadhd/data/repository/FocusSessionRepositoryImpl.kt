...
import io.yavero.pocketadhd.domain.model.FocusSession
import io.yavero.pocketadhd.domain.repository.FocusSessionRepository
...
class FocusSessionRepositoryImpl(
    ...
    private fun mapEntityToDomain(entity: io.yavero.pocketadhd.data.database.FocusSessionEntity): FocusSession {
        return FocusSession(
            id = entity.id,
