...
import io.yavero.pocketadhd.domain.model.Subtask
import io.yavero.pocketadhd.domain.model.Task
import io.yavero.pocketadhd.domain.repository.TaskRepository
...
class TaskRepositoryImpl(
    ...
    private fun mapEntityToDomain(entity: io.yavero.pocketadhd.data.database.TaskEntity): Task {
    ...
    private fun mapSelectTasksByDueDateToDomain(entity: io.yavero.pocketadhd.data.database.SelectTasksByDueDate): Task {
        val subtasks = database.taskQueries.selectSubtasksByTaskId(entity.id)
            .executeAsList()
            .map { subtaskEntity ->
                Subtask(
