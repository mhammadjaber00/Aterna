...
interface QuestRepository {
    ...
    suspend fun saveQuestPlan(questId: String, plans: List<io.yavero.aterna.domain.model.quest.PlannedEvent>)
    suspend fun getQuestPlan(questId: String): List<io.yavero.aterna.domain.model.quest.PlannedEvent>
    suspend fun clearQuestPlan(questId: String)

    suspend fun appendQuestEvent(event: io.yavero.aterna.domain.model.quest.QuestEvent)
    suspend fun getQuestEvents(questId: String): List<io.yavero.aterna.domain.model.quest.QuestEvent>
